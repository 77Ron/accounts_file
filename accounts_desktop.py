...
Style().configure('Acct.TFrame', background='PaleTurquoise3', foreground = 'black')
...
uname_label = tk.Label(root, text = 'Username:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
...
ename_label = tk.Label(root, text = 'Customer Name:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
...
esname_label = tk.Label(root, text = 'Surname:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
...
eid_label = tk.Label(root, text = 'ID/Account No.:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
...
eaddress1_label = tk.Label(root, text = 'Address1:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
...
eaddress2_label = tk.Label(root, text = 'Address2:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
...
ecode_label = tk.Label(root, text = 'Post Code:', font=('calibre',10, 'bold'), bg='PaleTurquoise3')
