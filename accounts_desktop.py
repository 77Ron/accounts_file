...
def UpdateAccounts():
    ...
    frame = tk.Frame(root, width = '500', height = '700', bg=bgcol)
    frame.pack()
    ...
    eaddress3_var = tk.StringVar()
    ecode_var = tk.StringVar()
    emobile_var = tk.StringVar()
    eemail_var = tk.StringVar()
    ...
    eaddress2_entry = tk.Entry(root,textvariable = eaddress3_var, font=('calibre',10,'normal'), width=25)
    ...
    ecode_entry = tk.Entry(root,textvariable = emobile_var, font=('calibre',10,'normal'), width=10)
    ...
    ecode_entry = tk.Entry(root,textvariable = eemail_var, font=('calibre',10,'normal'), width=30)
    ...
    #---Save----
    save_btn = tk.Button(root,text = 'Save Updates', command = lambda: save(name_var), font=('garamond', 12, 'bold'), bg=btcol, fg='black')
